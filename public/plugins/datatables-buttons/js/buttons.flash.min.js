(function (g) {
  'function' === typeof define && define.amd
    ...
    ? (module.exports = function (j, m) {
        ...
        m.fn.dataTable.Buttons || require('datatables.net-buttons')(j, m);
        return g(m, j, j.document);
      })
  ...
  function x(a) {
    r === p &&
      (r =
        -1 ===
        v
          .serializeToString(g.parseXML(q['xl/worksheets/sheet1.xml']))
          .indexOf('xmlns:r'));
    ...
    A = function (a, b) {
      for (
        var d = z(b),
          ...
          m = b.header ? j(c.header) + d : '',
          o = b.footer && c.footer ? d + j(c.footer) : '',
          n = [],
          l = 0,
          h = c.body.length;
        l < h;
        ...
        n.push(j(c.body[l]));
      return { str: m + n.join(d) + o, rows: n.length };
    },
    u = {
      available: function () {
        return i.hasFlash();
  ...
  h.ext.buttons.copyFlash = g.extend({}, u, {
  ...
  h.ext.buttons.csvFlash = g.extend({}, u, {
  ...
  h.ext.buttons.excelFlash = g.extend({}, u, {
    ...
    action: function (a, b, d, c) {
      ...
      var a = c._flash,
        e = 0,
        f = g.parseXML(q['xl/worksheets/sheet1.xml']),
        i = f.getElementsByTagName('sheetData')[0],
        d = {
          _rels: { '.rels': g.parseXML(q['_rels/.rels']) },
          xl: {
            _rels: {
              'workbook.xml.rels': g.parseXML(q['xl/_rels/workbook.xml.rels']),
            },
            'workbook.xml': g.parseXML(q['xl/workbook.xml']),
            'styles.xml': g.parseXML(q['xl/styles.xml']),
            worksheets: { 'sheet1.xml': f },
          },
          '[Content_Types].xml': g.parseXML(q['[Content_Types].xml']),
        },
        ...
        h = function (a) {
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            a[b] = 'function' === typeof a[b].trim ? a[b].trim() : a[b];
            for (var k = 0, n = B.length; k < n; k++) {
              var l = B[k];
              if (a[b].match && !a[b].match(/^0\d+/) && a[b].match(l.match)) {
                h = a[b].replace(/[^\d\.\-]/g, '');
                l.fmt && (h = l.fmt(h));
                h = o(f, 'c', {
                  attr: { r: g, s: l.style },
                  children: [o(f, 'v', { text: h })],
                });
                break;
              }
            }
      ...
      var n = function (a, b) {
          ...
          c[0].appendChild(
            o(f, 'mergeCell', { attr: { ref: 'A' + a + ':' + w(b) + a } })
          );
          c.attr('count', c.attr('count') + 1);
          g('row:eq(' + (a - 1) + ') c', f).attr('s', '51');
        },
        l = b.buttons.exportInfo(c);
      l.title && (h([l.title], e), n(e, k.header.length - 1));
      l.messageTop && (h([l.messageTop], e), n(e, k.header.length - 1));
      c.header && (h(k.header, e), g('row:last c', f).attr('s', '2'));
      for (var s = 0, r = k.body.length; s < r; s++) h(k.body[s], e);
      c.footer &&
        k.footer &&
        (h(k.footer, e), g('row:last c', f).attr('s', '2'));
      l.messageBottom && (h([l.messageBottom], e), n(e, k.header.length - 1));
      h = o(f, 'cols');
      g('worksheet', f).prepend(h);
      n = 0;
      for (s = k.header.length; n < s; n++)
        h.appendChild(
          o(f, 'col', {
            attr: { min: n + 1, max: n + 1, width: C(k, n), customWidth: 1 },
          })
        );
      c.customize && c.customize(d, c, b);
      x(d);
      a.setAction('excel');
      a.setFileName(l.filename);
      a.setSheetData(d);
      t(a, '');
      this.processing(!1);
    },
  ...
  h.ext.buttons.pdfFlash = g.extend({}, u, {
