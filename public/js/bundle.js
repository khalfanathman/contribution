...
parcelRequire = (function (modules, cache, entry, globalName) {
...
})(
  {
    ...
    '../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/base64-js/index.js':
      [
        function (require, module, exports) {
          'use strict';
    ...
    '../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/ieee754/index.js':
      [
        function (require, module, exports) {
    ...
    '../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/isarray/index.js':
      [
        function (require, module, exports) {
          var toString = {}.toString;
    ...
    '../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js':
      [
        function (require, module, exports) {
          var global = arguments[3];
          /*!
 ...
 */
                      ...
                      case 4:
                        ...
                        if (res.data.status === 'success') {
                          ...
                          window.setTimeout(function () {
                            location.assign('/'); // location.replace(document.referrer);
                          }, 1500);
                        }
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'POST',
                          url: '/api/v1/contributions/'.concat(
                            contribId,
                            '/transactions'
                          ),
                          data: {
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        var logOutBtn = document.getElementById('logoutModal');
        var userPasswordForm = document.querySelector('.form-user-password');
        var updateUser = document.querySelector('.userform');
        var contributeEvent = document.querySelector('.contribform'); // DOM ELEMENTS
        //VALUES

        if (contributeEvent) {
          contributeEvent.addEventListener('click', function (e) {
            e.preventDefault();
            document.querySelector('.cntribtbtn').textContent = 'Processing...';
            var contribId = e.target.dataset.contribId;
            console.log(contribId);
            var phone = document.getElementById('phone').value;
            var amount = document.getElementById('amount').value;
            var sms = document.getElementById('sms').value;
            if (contribId)
              (0, _mpesa.trasnactMpesa)(phone, amount, sms, contribId);
                  ...
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          e.preventDefault();
                          document.querySelector('.submtbtn').textContent =
                            'Updating...';
